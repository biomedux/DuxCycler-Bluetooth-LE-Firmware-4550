...
#define HARDWARE_PROFILE_PICDEM_FSUSB_H
    ...
    #define mLED_G_Toggle()     mLED_G = !mLED_G;

	#define mInitAllLEDs()	{mLED_R_Off();mLED_T_Off();mLED_B_Off();mLED_G_Off();TRISDbits.TRISD0=OUTPUT_PIN;TRISDbits.TRISD1=OUTPUT_PIN;TRISDbits.TRISD2=OUTPUT_PIN;TRISDbits.TRISD3=OUTPUT_PIN;}
...
/** ADC for temperature sensor*********************************************/
	...
	/**heater ************************************************************/
	//#define InitHeater()		TRISC &= 0x7F; LATCbits.LATC7=0;
